  ...
  return (
    <footer className="w-full bg-white py-16 px-6">
      <div className="flex flex-col md:flex-row items-center justify-center max-w-6xl mx-auto w-full relative">
        ...
        <div className="absolute md:hidden w-[200px] h-px bg-[#E0E0E0] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />

        <div className="hidden md:block w-px h-[140px] bg-[#E0E0E0] mr-8 ml-4" />
